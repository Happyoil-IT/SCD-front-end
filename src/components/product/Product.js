          ...
          <Table stickyHeader>
            <TableHead>
              <TableRow>
                ...
                <TableCell sx={{ backgroundColor: theme.palette.error.main, color: "white", textAlign: "center" }}>SG</TableCell>
                <TableCell sx={{ backgroundColor: theme.palette.error.main, color: "white", textAlign: "center" }}>PD_Name</TableCell>
